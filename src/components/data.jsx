...
const data = ({user,index}) => {
 ...
 if(user.name!='' && user.age !='' && user.email!= ''){
   return (
    <div className="flex h-[15%] w-[98%] md:text-[1.5rem] text-[1rem] rounded-[20px] inset-shadow-[2px_2px_5px_rgba(0,0,0,0.5),-2px_-2px_3px_rgb(216,215,215)] bg-yellow-100 self-center">
